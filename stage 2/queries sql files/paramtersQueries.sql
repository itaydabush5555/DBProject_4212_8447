...
-- Query 5: Filter Products by Multiple Categories
-- This query allows filtering products based on multiple categories.
-- Options Used: name, list.
-- Usage: Select one category from the provided list.
SELECT * 
FROM Product 
WHERE CATEGORY IN ('&<name="Categories" list="SELECT DISTINCT Category FROM Product ORDER BY Category"  >')
/
